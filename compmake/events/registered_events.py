...
compmake_registered_events["job-progress"] = EventSpec(name='job-progress', attrs=['job_id', 'host', 'done', 'progress', 'goal'], desc=None, file='compmake/jobs/actions.py', line=82)
compmake_registered_events["job-succeeded"] = EventSpec(name='job-succeeded', attrs=['job_id', 'host'], desc=None, file='compmake/jobs/actions.py', line=83)
compmake_registered_events["job-failed"] = EventSpec(name='job-failed', attrs=['job_id', 'host', 'reason'], desc=None, file='compmake/jobs/actions.py', line=84)
compmake_registered_events["job-instanced"] = EventSpec(name='job-instanced', attrs=['job_id', 'host'], desc=None, file='compmake/jobs/actions.py', line=85)
compmake_registered_events["job-starting"] = EventSpec(name='job-starting', attrs=['job_id', 'host'], desc=None, file='compmake/jobs/actions.py', line=86)
compmake_registered_events["job-finished"] = EventSpec(name='job-finished', attrs=['job_id', 'host'], desc=None, file='compmake/jobs/actions.py', line=87)
compmake_registered_events["job-interrupted"] = EventSpec(name='job-interrupted', attrs=['job_id', 'host', 'reason'], desc=None, file='compmake/jobs/actions.py', line=88)
compmake_registered_events["job-now-ready"] = EventSpec(name='job-now-ready', attrs=['job_id'], desc=None, file='compmake/jobs/actions.py', line=89)
