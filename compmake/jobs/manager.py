################################################################################
# Events generated by this module. This declaration is parsed by a script.
#
# event { 'name': 'manager-init',     'attrs': ['targets', 'more'] }
# event { 'name': 'manager-progress', 'attrs': ['targets','all_targets', 'done', 'todo','failed','ready','processing'] }
# event { 'name': 'manager-succeeded', 'attrs': ['targets', 'all_targets','done', 'todo','failed','ready','processing'] }
# event { 'name': 'manager-interrupted', 'attrs': ['targets', 'all_targets','done', 'todo','failed','ready','processing'] }
# event { 'name': 'manager-failed', 'attrs': ['reason', 'targets', 'all_targets','done', 'todo','failed','ready','processing'] }
#
################################################################################
